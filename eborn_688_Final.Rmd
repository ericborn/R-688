...
# add new column which is the total points from field goals, three pointers and total points
...
points <- head(wolves[order(wolves$relTotal, decreasing = TRUE),c(2,21)], n=3)
...
### At a glance
In the 2003-2004 season there were 29 unique teams and 442 unique players. The average number of minutes a player played throughout the season was 1300, over 21 hours! The total points scored based upon the NBA calculation was just over 222k, but calculated where each baseket is worth its real in-game points the total was over 246K, an increase of 24K. There were over 100k rebounds and 12k blocked shots.
...
### Top 5 by Wins
The top 5 teams by record was the Pacers, which was the only team in the top 5 to come from the Eastern conference, the Timberwolves and the Spurs out of the Midwest division, followed by the Lakers and the Kings out of the Pacific division. The 6th place team for total overall wins was the Pisons with a record of 54 and 28 and they ended up going on to win the championship against the Lakers.
...
Looking at the top 10 teams by total points we see a pretty close spread, but definitely doesn't follow the same pattern as total wins. Dallas was the highest overall for points, but placed 7th in the season for number of wins, followed by Sacramento, Seattle and Milwaukee, who all save for Sacramento weren't in the top 5 teams for wins.
...
wolves.plot
```
When comparing the point distribution across the wolves, we can see three major players contributed the most in this category. Kevin Garnett provided just over 2000 points, 368 from free throws, 33 from threes and 1608 from field goals. Sam Cassell provided 1240 field goals, 222 threes and 289 free throws. Finally Latrell Sprewell shot 1036 field goals, 297 threes and 240 free throws.

```{r}
# draw plot
top.box
```
The third plot is a boxplot showing the point distributions across all players on each of the highest scoring teams. I found it interesting to note that the Rockets, Bucks and Trail Blazers all had one player who scored so many points they were an outlier and the Warriors actually had three players who were outliers on the plot. All of them appeared on the top scorers from part C, except Klay Thompson who was 17th overall for total points scored.
